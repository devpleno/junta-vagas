...
import { Client, Event, EventHint, Integration, IntegrationClass, Options, Severity, Transport } from '@sentry/types';
...
export declare abstract class BaseClient<B extends Backend, O extends Options> implements Client<O> {
     ...
     */
    protected _ensureBeforeSendRv(rv: PromiseLike<Event | null> | Event | null): PromiseLike<Event | null> | Event | null;
}
