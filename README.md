...
====================================================
- Coluna **Backlog** possui funcionalidades com o clientes pedido
- Coluna **Blocked** são as tarefas que estão bloqueadas por algum motivo
- Coluna **Todo** são as tarefas para serem feitas
